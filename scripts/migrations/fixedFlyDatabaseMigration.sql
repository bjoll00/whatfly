-- FIXED FLY DATABASE MIGRATION
-- This script uses only the fly types allowed by the database constraint
...
-- Using only allowed fly types: dry, wet, nymph, streamer, terrestrial, attractor, imitation
INSERT INTO flies (
...
-- ========================================
-- TERRESTRIALS - Land-Based Insect Patterns
-- ========================================
...
(
  gen_random_uuid(), 'Soft Hackle Pheasant Tail', 'wet', 'SHPT',
  ARRAY['14', '16', '18', '20'],
  '16', 'Brown', ARRAY['Olive', 'Black', 'Copper'],
  'Traditional soft hackle wet fly. Excellent for swinging and dead drifting.',
  '{
    "weather": ["cloudy", "overcast", "rainy"],
    "water_clarity": ["clear", "slightly_murky", "murky"],
    "water_level": ["normal", "high"],
  ...
  'intermediate', 'medium', 0.75, 120, 90, NOW(), NOW()
),

-- Partridge and Orange
(
  gen_random_uuid(), 'Partridge and Orange', 'wet', 'P&O',
  ARRAY['12', '14', '16', '18'],
  '14', 'Orange', ARRAY['Yellow', 'Red', 'Gold'],
  'Classic North Country wet fly. Simple but effective traditional pattern.',
  '{
    "weather": ["cloudy", "overcast", "rainy"],
    "water_clarity": ["clear", "slightly_murky"],
    "water_level": ["normal", "low"],
  ...
  'intermediate', 'easy', 0.72, 100, 72, NOW(), NOW()
),

-- ========================================
-- ATTRACTOR PATTERNS - High Visibility Flies
-- ========================================

-- Royal Wulff
(
  gen_random_uuid(), 'Royal Wulff', 'attractor', 'Royal Wulff',
  ARRAY['8', '10', '12', '14', '16'],
  '12', 'Red', ARRAY['Yellow', 'White', 'Black'],
  'Classic attractor pattern. Excellent for rough water and as a search pattern.',
  '{
    "weather": ["sunny", "cloudy", "overcast"],
    "water_clarity": ["clear", "slightly_murky", "murky"],
    "water_level": ["normal", "high"],
  ...
  '{
    "primary": ["trout"],
    "secondary": ["grayling", "bass"],
    "size_preference": "large"
  }'::jsonb,
  '{
    "insects": ["attractor", "mayfly"],
    "stages": ["adult", "attractor"],
    "sizes": ["8", "10", "12", "14"]
  }'::jsonb,
  '{
  ...
  'beginner', 'medium', 0.73, 150, 109, NOW(), NOW()
);
